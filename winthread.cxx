...
DWORD WINAPI BGI__ThreadInitWindow( LPVOID pThreadData )
{
    ...
    // BLumia: If you are willing to switch back to SetWindowLong which is superseded by 
    //         SetWindowLongPtr, uncomment next line and comment line after the next line.
